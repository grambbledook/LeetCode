...
class WiggleSortTest {
    ...
    @Test
    fun `test case 4`() {
        listOf(1, 3, 2, 2, 2, 1, 1, 3, 1, 1, 2).let {
            doTest(it)
        }
    }
    ...
    @Test
    fun `test case 10`() {
        listOf(3, 3, 3, 2, 2, 2, 3, 2, 1, 1, 2, 1, 2, 3, 3, 3, 1, 2).let {
            doTest(it)
        }
    }
